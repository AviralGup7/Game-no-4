...
/// >=4.5:1 (AA) otherwise. Numerals and chevrons ARE the content here.
library;
...
class AppTheme {
  ...
  static Color sameValueFill(ColorScheme s) =>
      s.secondary.withValues(alpha: s.brightness == Brightness.dark ? .26 : .18);
  static Color hintFill(ColorScheme s) => const Color(0xFF2E9B57).withValues(alpha: .40);
  static Color signColour(ColorScheme s) =>
