    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: ListenableBuilder(
          listenable: Listenable.merge([s, iap]),
          builder: (context, _) {
            ...
            return ListView(
              ...
              children: [
                ...
                // Live preview: the effect is visible while dragging.
                Center(
                    child: Text('4',
                        style: TextStyle(
                            fontSize: 40 * fs, fontWeight: FontWeight.bold))),
                Slider(
                  value: s.fontScale,
                  min: 0.85,
                  max: 1.6,
                ...
                SwitchListTile(
                  ...
                  subtitle: Text('Shade the line you are working in',
                      style: sub()),
                  value: s.highlightPeers,
                  onChanged: s.setHighlightPeers,
                ),
                SwitchListTile(
                  title: Text('Show mistakes', style: label()),
                  subtitle:
                      Text('Mark a wrong number straight away', style: sub()),
